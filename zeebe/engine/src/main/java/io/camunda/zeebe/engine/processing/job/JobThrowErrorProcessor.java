...
public class JobThrowErrorProcessor implements CommandProcessor<JobRecord> {
  ...
  private static final String ERROR_REJECTION_MESSAGE = "Cannot throw BPMN error from %s job.";
  ...
  private void acceptCommand(
    ...
    if (jobKind == JobKind.EXECUTION_LISTENER) {
      commandControl.reject(
          RejectionType.INVALID_STATE, String.format(ERROR_REJECTION_MESSAGE, jobKind));
      return;
    }
