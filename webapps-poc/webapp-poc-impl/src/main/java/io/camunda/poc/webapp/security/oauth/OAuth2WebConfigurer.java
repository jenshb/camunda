...
import static io.camunda.poc.webapp.util.CollectionUtil.firstOrDefault;
import static io.camunda.poc.webapp.util.CollectionUtil.getOrDefaultFromMap;

import io.camunda.poc.webapp.property.ClientProperties;
...
public class OAuth2WebConfigurer {
  ...
  @Autowired private WebAppsPocProperties config;
