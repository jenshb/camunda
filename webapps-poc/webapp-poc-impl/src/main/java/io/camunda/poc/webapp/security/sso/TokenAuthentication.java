 ...
 */
package io.camunda.poc.webapp.security.sso;
...
@Profile(WebAppPocProfileService.SSO_AUTH_PROFILE)
@Component
...
public class TokenAuthentication extends AbstractAuthenticationToken implements OldUsernameAware {
  ...
  @Value("${" + WebAppsPocProperties.PREFIX + ".auth0.claimName}")
  private String claimName;

  @Value("${" + WebAppsPocProperties.PREFIX + ".auth0.organization}")
  private String organization;

  @Value("${" + WebAppsPocProperties.PREFIX + ".auth0.domain}")
  private String domain;

  @Value("${" + WebAppsPocProperties.PREFIX + ".auth0.clientId}")
  private String clientId;

  @Value("${" + WebAppsPocProperties.PREFIX + ".auth0.clientSecret}")
