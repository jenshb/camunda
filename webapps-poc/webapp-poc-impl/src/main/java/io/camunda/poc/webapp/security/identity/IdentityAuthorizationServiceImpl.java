...
import static io.camunda.poc.webapp.property.IdentityProperties.ALL_RESOURCES;
import static io.camunda.poc.webapp.property.IdentityProperties.FULL_GROUP_ACCESS;
...
import io.camunda.poc.webapp.security.sso.TokenAuthentication;
...
public class IdentityAuthorizationServiceImpl implements IdentityAuthorizationService {
  ...
  private Optional<IdentityAuthorization> getIdentityAuthorization() {
    if (!webAppsPocProperties.getIdentity().isResourcePermissionsEnabled()
