...
public abstract class DateUtil {
  ...
  public static OffsetDateTime getRandomEndDate(final boolean nullable) {
    if (nullable) {
  ...
  public static OffsetDateTime toOffsetDateTime(final String timestamp, final String pattern) {
