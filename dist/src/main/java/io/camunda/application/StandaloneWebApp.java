...
import io.camunda.poc.WebappPocModuleConfiguration;
...
public class StandaloneWebApp {
  ...
  public static void main(final String[] args) {
    ...
    final var standaloneWebAppApplication =
        MainSupport.createDefaultApplicationBuilder()
            .sources(
                CommonsModuleConfiguration.class,
                WebappPocModuleConfiguration.class,
                WebappsModuleConfiguration.class)
            .profiles(Profile.WEBAPPS.getId(), Profile.STANDALONE.getId())
    ...
    standaloneWebAppApplication.run(args);
  }
